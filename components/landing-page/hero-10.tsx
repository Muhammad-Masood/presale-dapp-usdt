...
const Hero10: React.FC = () => {
  return (
    <section className="relative bg-bg-gradientHero3">
      ...
      <div className="grid p-10 md:p-28 md:grid-cols-2 gap-4 grid-cols-1">
        <Card className="bg-transparent relative border-[#FFD178] px-4 py-8 md:px-12 md:py-20 rounded-3xl">
          <img
          ...
          <div className="flex flex-col md:flex-row justify-start md:justify-center items-center">
            <div className="order-2 md:order-1 ml-4 flex    gap-4 flex-col">
            ...
            <div className="w-2/3 min-w-36 mr-16  md:mr-11">
              <img
